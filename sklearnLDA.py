...
def display_topics(H, W, feature_names, documents, no_top_words, no_top_documents):
    ...
    archivo = open('Resultados/txt/LDA-' + str(nTopics) + '-' + str(alpha) + '-' + str(eta) + '-NintPos.txt', 'w')   #PARA QUE SALGA EN FORMATO TXT
...
df_document_topic.to_csv("Resultados/Topics-review/NintTMPos2.csv")
